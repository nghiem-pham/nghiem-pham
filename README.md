...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <img src="https://img.shields.io/badge/WebSocket-4353FF?style=flat-square&logo=socket.io&logoColor=white"/>
    </td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p align="center">Full-stack social hiring platform with preference-ranked job discovery, developer hub, community forums, and real-time messaging</p>
      <p align="center">
        <a href="https://spin-node.com">spin-node.com</a>
      </p>
      <p align="center">
      ...
      <ul>
        <li>40+ REST endpoints secured with JWT + Google OAuth2</li>
        <li>AI-powered resume parsing and job matching via Groq (Llama 3.3 70B)</li>
        <li>WebSocket messaging with Redis caching and 25 Flyway migrations</li>
      </ul>
    </td>
    <td width="50%">
      <h3 align="center">Streamable</h3>
      <p align="center">Full-stack live streaming platform with browser broadcasting, RTMP ingest, HLS playback, and live chat</p>
      <p align="center">
        <a href="https://stream-able.com">stream-able.com</a>
      </p>
      <p align="center">
      ...
      <ul>
        ...
        <li>Live chat, reactions, and subscriber notifications via WebSocket hubs</li>
      </ul>
    </td>
  </tr>
</table>
